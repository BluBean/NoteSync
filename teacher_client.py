...
def mainwindow():
    ...
    bpm_label = Label(mainwindow, text ="Beats Per Minute", bg='#99AAB5')#, bg="red", fg ="gray")
    ...
    time_sig_label = Label(mainwindow, text ="Time Signature Numerator", bg='#99AAB5')#, bg="red", fg ="gray")
    ...
    time_sigd_label = Label(mainwindow, text ="Time Signature Denominator", bg='#99AAB5')#, bg="red", fg ="gray")
