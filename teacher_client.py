...
def display_offsets():
    ...
    elif total_var.get() == 9 :
        Delay8_label.place(x=10, y=230)
        Delay9_label.place_forget()
        S8.place(x=130, y=230)
        S9.place_forget()
    elif total_var.get() == 8 :
        Delay7_label.place(x=10, y=210)
        Delay8_label.place_forget()
        S7.place(x=130, y=210)
        S8.place_forget()
    elif total_var.get() == 7 :
        Delay6_label.place(x=10, y=190)
        Delay7_label.place_forget()
        S6.place(x=130, y=190)
        S7.place_forget()
    elif total_var.get() == 6 :
        Delay5_label.place(x=10, y=170)
        Delay6_label.place_forget()
        S5.place(x=130, y=170)
        S6.place_forget()
    elif total_var.get() == 5 :
        Delay4_label.place(x=10, y=150)
        Delay5_label.place_forget()
        S4.place(x=130, y=150)
        S5.place_forget()
    elif total_var.get() == 4 :
        Delay3_label.place(x=10, y=130)
        Delay4_label.place_forget()
        S3.place(x=130, y=130)
        S4.place_forget()
    elif total_var.get() == 3 :
        Delay2_label.place(x=10, y=110)
        Delay3_label.place_forget()
        S2.place(x=130, y=110)
        S3.place_forget()
    elif total_var.get() == 2 :
        Delay1_label.place(x=10, y=90)
        Delay2_label.place_forget()
        S1.place(x=130, y=90)
        S2.place_forget()
    elif total_var.get() == 1:
        Delay0_label.place(x=10, y=70)
        Delay1_label.place_forget()
        Delay2_label.place_forget()
        Delay3_label.place_forget()
        Delay4_label.place_forget()
        Delay5_label.place_forget()
...
def mainwindow():
    ...
    global S0,S1, S2, S3, S4, S5, S6, S7, S8, S9, progress_var, total_var
    global Delay0_label,Delay1_label, Delay2_label, Delay3_label, Delay4_label
    global Delay5_label, Delay6_label, Delay7_label, Delay8_label, Delay9_label
    ...
    bpm_label.place(x=400, y=10)
    bpm_slider = Scale(mainwindow, from_=1, to=200, width=15,length = 325, orient=HORIZONTAL,  bg='#99AAB5') #, tickinterval=100,orient=HORIZONTAL)
    bpm_slider.set(100)
    bpm_slider.place(x=250, y=30)
    time_sig_label = Label(mainwindow, text ="Time Signature", bg='#99AAB5')#, bg="red", fg ="gray")
    time_sig_label.place(x=330, y=120)
    ...
    time_sig_top.place(x=440, y=100)
    tsig_bar = Label(mainwindow, text="----", bg='#99AAB5')  # , bg="red", fg ="gray")
    tsig_bar.place(x=430, y=120)
    ...
    time_sig_bottom.place(x=440, y=140)
    measures_label = Label(mainwindow, text ="Total Measures", bg='#99AAB5')#, bg="red", fg ="gray")
    measures_label.place(x=370, y =180)
    measures_slider = Scale(mainwindow, from_=1, to=80, width=15,length = 325, orient=HORIZONTAL, bg='#99AAB5')
    measures_slider.place(x=250, y=200)
    ...
    Delay0_label.place(x=10, y=70)
    S0 = Spinbox(mainwindow, from_ = 0, to = 9, width = 2, font=("Arial 11"),wrap = True, bg='#99AAB5',state = 'readonly',readonlybackground = '#99AAB5', bd=0)
    S0.place(x=130, y=70)
    Delay1_label = Label(mainwindow, text ="Student 1 Delay :", bg='#99AAB5')
    #Delay1_label.place(x=10, y=90)
    S1 = Spinbox(mainwindow, from_ = 0, to = 9, width = 2, font=("Arial 11"),wrap = True, bg='#99AAB5',state = 'readonly',readonlybackground = '#99AAB5', bd=0)
    #S1.place(x=130, y=90)
    Delay2_label = Label(mainwindow, text ="Student 2 Delay :", bg='#99AAB5')
    #Delay2_label.place(x=10, y=110)
    S2 = Spinbox(mainwindow, from_ = 0, to = 9, width = 2, font=("Arial 11"),wrap = True, bg='#99AAB5',state = 'readonly',readonlybackground = '#99AAB5', bd=0)
    #S2.place(x=130, y=110)
    Delay3_label = Label(mainwindow, text ="Student 3 Delay :", bg='#99AAB5')
    #Delay3_label.place(x=10, y=130)
    S3 = Spinbox(mainwindow, from_ = 0, to = 9, width = 2, font=("Arial 11"),wrap = True, bg='#99AAB5',state = 'readonly',readonlybackground = '#99AAB5', bd=0)
    #S3.place(x=130, y=130)
    Delay4_label = Label(mainwindow, text ="Student 4 Delay :", bg='#99AAB5')
    #Delay4_label.place(x=10, y=150)
    S4 = Spinbox(mainwindow, from_ = 0, to = 9, width = 2, font=("Arial 11"),wrap = True, bg='#99AAB5',state = 'readonly',readonlybackground = '#99AAB5', bd=0)
    #S4.place(x=130, y=150)
    Delay5_label = Label(mainwindow, text="Student 5 Delay :", bg='#99AAB5')
    #Delay5_label.place(x=10, y=170)
    S5 = Spinbox(mainwindow, from_=0, to=9, width=2, font=("Arial 11"), wrap=True, bg='#99AAB5',state = 'readonly',readonlybackground = '#99AAB5', bd=0)
    #S5.place(x=130, y=170)
    Delay6_label = Label(mainwindow, text ="Student 6 Delay :", bg='#99AAB5')
    #Delay6_label.place(x=10, y=190)
    S6 = Spinbox(mainwindow, from_ = 0, to = 9, width = 2, font=("Arial 11"),wrap = True, bg='#99AAB5',state = 'readonly',readonlybackground = '#99AAB5', bd=0)
    #S6.place(x=130, y=190)
    Delay7_label = Label(mainwindow, text ="Student 7 Delay :", bg='#99AAB5')
    #Delay7_label.place(x=10, y=210)
    S7 = Spinbox(mainwindow, from_ = 0, to = 9, width = 2, font=("Arial 11"),wrap = True, bg='#99AAB5',state = 'readonly',readonlybackground = '#99AAB5', bd=0)
    #S7.place(x=130, y=210)
    Delay8_label = Label(mainwindow, text="Student 8 Delay :", bg='#99AAB5')
    #Delay8_label.place(x=10, y=230)
    S8 = Spinbox(mainwindow, from_=0, to=9, width=2, font=("Arial 11"), wrap=True, bg='#99AAB5',state = 'readonly',readonlybackground = '#99AAB5', bd=0)
    #S8.place(x=130, y=230)
    Delay9_label = Label(mainwindow, text="Student 9 Delay :", bg='#99AAB5')
    #Delay9_label.place(x=10, y=250)
    S9 = Spinbox(mainwindow, from_=0, to=9, width=2, font=("Arial 11"), wrap=True, bg='#99AAB5',state = 'readonly',readonlybackground = '#99AAB5', bd=0)
    #S9.place(x=130, y=250)
