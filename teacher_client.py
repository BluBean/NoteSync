...
def mainwindow():
    ...
    time_sig_top = Spinbox(mainwindow, from_ = 0, to = 9, width = 2, font=("Arial 11"),wrap = True, bg='#99AAB5')   #tickinterval=8,,orient=HORIZONTAL)
    time_sig_top.place(x=325, y=50)
    tsig_bar = Label(mainwindow, text="____", bg='#99AAB5')  # , bg="red", fg ="gray")
    tsig_bar.place(x=300, y=50)
    time_sig_bottom = Spinbox(mainwindow, from_ = 0, to = 9, width = 2, font=("Arial 11"), wrap = True, bg='#99AAB5')   #,tickinterval=8,orient=HORIZONTAL)
    time_sig_bottom.place(x=325, y=90)
    ...
    student_amount.place(x=10, y=50)
    ...
    S8 = Spinbox(mainwindow, from_=0, to=9, width=2, font=("Arial 11"), wrap=True, bg='#99AAB5')
    S8.place(x=98, y=230)
    Delay9_label = Label(mainwindow, text="Student 9 Delay", bg='#99AAB5')
    Delay9_label.place(x=10, y=250)
    S9 = Spinbox(mainwindow, from_=0, to=9, width=2, font=("Arial 11"), wrap=True, bg='#99AAB5')
    S9.place(x=98, y=250)
