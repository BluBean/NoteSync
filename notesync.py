...
bpm_label = Label(mainwindow, text ="Beats Per Minute")#, bg="red", fg ="white")
bpm_label.pack()
bpm_slider = Scale(mainwindow, from_=1, to=200) #, tickinterval=100,orient=HORIZONTAL)
bpm_slider.set(100)
bpm_slider.pack()
time_sig_label = Label(mainwindow, text ="Time Signature Numerator")#, bg="red", fg ="white")
time_sig_label.pack()
...
measures_label = Label(mainwindow, text ="Measures From start")#, bg="red", fg ="white")
measures_label.pack()
