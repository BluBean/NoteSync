...
S1.pack()
Delay2_label = Label(mainwindow, text ="Student 2 Delay (whole measures)", bg = 'gray')
Delay2_label.pack()
S2 = Spinbox(mainwindow, from_ = 0, to = 9)
S2.pack()
Delay3_label = Label(mainwindow, text ="Student 3 Delay (whole measures)", bg = 'gray')
Delay3_label.pack()
S3 = Spinbox(mainwindow, from_ = 0, to = 9)
S3.pack()
Delay4_label = Label(mainwindow, text ="Student 4 Delay (whole measures)", bg = 'gray')
Delay4_label.pack()
S4 = Spinbox(mainwindow, from_ = 0, to = 9)
S4.pack()
Delay5_label = Label(mainwindow, text ="Student 5 Delay (whole measures)", bg = 'gray')
Delay5_label.pack()
