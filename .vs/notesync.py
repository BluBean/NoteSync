...
bpm_slider = Scale(mainwindow, from_=1, to=200, width=9, orient=HORIZONTAL, bg = '#99AAB5') #, tickinterval=100,orient=HORIZONTAL)

bpm_label.pack()
bpm_slider = Scale(mainwindow, from_=1, to=200, bg = '#99AAB5') #, tickinterval=100,orient=HORIZONTAL)
...
time_sig_slider = Scale(mainwindow, from_=1, to=16, width=10, orient=HORIZONTAL, bg = '#99AAB5')   #tickinterval=8,,orient=HORIZONTAL)
...
time_sigd_slider = Scale(mainwindow, from_=1, to=8,orient=HORIZONTAL, bg = '#99AAB5')   #,tickinterval=8,orient=HORIZONTAL)
...
measures_slider = Scale(mainwindow, from_=1, to=80,orient=HORIZONTAL, bg = '#99AAB5')   #,tickinterval=8,orient=HORIZONTAL)
...
S2 = Spinbox(mainwindow, from_ = 0, to = 9, width = 2, font=("Arial 11"))
S2.place(x=98, y=30)
Delay3_label = Label(mainwindow, text ="Student 3 Delay", bg='#99AAB5')
Delay3_label.place(x=10, y=50)
S3 = Spinbox(mainwindow, from_ = 0, to = 9, width = 2, font=("Arial 11"))
S3.place(x=98, y=50)
Delay4_label = Label(mainwindow, text ="Student 4 Delay", bg='#99AAB5')
Delay4_label.place(x=10, y=70)
S4 = Spinbox(mainwindow, from_ = 0, to = 9, width = 2, font=("Arial 11"))
S4.place(x=98, y=70)
Delay5_label = Label(mainwindow, text ="Student 5 Delay", bg='#99AAB5')
Delay5_label.place(x=10, y=90)
S5 = Spinbox(mainwindow, from_ = 0, to = 9, width = 2, font=("Arial 11"))
S5.place(x=98, y=90)
Delay6_label = Label(mainwindow, text ="(whole measures)", bg='#99AAB5')
Delay6_label.place(x=15, y=110)
#(whole measures)

Delay1_label = Label(mainwindow, text ="Student 1 Delay (whole measures)", bg = '#99AAB5')
Delay1_label.pack()
S1 = Spinbox(mainwindow, from_ = 0, to = 9)
S1.pack()
Delay2_label = Label(mainwindow, text ="Student 2 Delay (whole measures)", bg = '#99AAB5')
Delay2_label.pack()
S2 = Spinbox(mainwindow, from_ = 0, to = 9)
S2.pack()
Delay3_label = Label(mainwindow, text ="Student 3 Delay (whole measures)", bg = '#99AAB5')
Delay3_label.pack()
S3 = Spinbox(mainwindow, from_ = 0, to = 9)
S3.pack()
Delay4_label = Label(mainwindow, text ="Student 4 Delay (whole measures)", bg = '#99AAB5')
Delay4_label.pack()
S4 = Spinbox(mainwindow, from_ = 0, to = 9)
S4.pack()
Delay5_label = Label(mainwindow, text ="Student 5 Delay (whole measures)", bg = '#99AAB5')
Delay5_label.pack()
